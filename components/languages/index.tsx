...
function SelectLanguage() {
  ...
  return (
    ...
    <DropdownMenu>
      <DropdownMenuTrigger className='flex flex-row-reverse justify-center items-center gap-1 p-1.5 hover:bg-custom-border-gray/20 rounded-md min-w-[60px] w-[99px] max-w-[99px] cursor-pointer -ml-3'>{selectedLanguage === "FA" ? " فارسی " : " English "} <GlobeIcon /> </DropdownMenuTrigger>
